...
export const I = {
  ...
  tour: (p: P) => <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" {...p}><circle cx="3.4" cy="3.4" r="1.7" /><circle cx="10.6" cy="10.6" r="1.7" /><path d="M3.4 5.1v2.5a2 2 0 0 0 2 2h3.2" /></svg>,
  ...
  // the Limn app mark — branch graph carrying a review check (version control + sign-off)
  mark: (p: P) => <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...p}><circle cx="3.5" cy="3" r="1.5" fill="currentColor" stroke="none" /><circle cx="3.5" cy="11" r="1.5" fill="currentColor" stroke="none" /><circle cx="10.5" cy="3" r="1.5" fill="currentColor" stroke="none" /><path d="M3.5 4.5v5M3.5 8.5C3.5 6 10.5 7.5 10.5 4.5" /><path d="M8.6 10.75l1.15 1.15 2.25-2.7" /></svg>,
  gear: (p: P) => <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" strokeLinecap="round" {...p}><path d="M5.8 1.4h2.4l.35 1.5a4 4 0 0 1 .95.55l1.45-.48 1.2 2.08-1.1 1a4.1 4.1 0 0 1 0 1.86l1.1 1-1.2 2.08-1.45-.48a4 4 0 0 1-.95.55l-.35 1.5H5.8l-.35-1.5a4 4 0 0 1-.95-.55l-1.45.48-1.2-2.08 1.1-1a4.1 4.1 0 0 1 0-1.86l-1.1-1 1.2-2.08 1.45.48a4 4 0 0 1 .95-.55z" /><circle cx="7" cy="7" r="1.85" /></svg>,
